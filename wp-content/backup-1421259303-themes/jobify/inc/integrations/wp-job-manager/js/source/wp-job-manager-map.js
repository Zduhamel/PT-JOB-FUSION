(function($) {
	...
	cLocator.Stage.prototype.adjustSize = function() {
		...
		if ( $( 'body' ).hasClass( 'page-template-page-templatesmap-jobs-php' ) || $( 'boyd' ).hasClass( 'page-template-page-templatesresume-jobs-php' ) ) {
		...
		if ( ( mapH + extraH ) > winH ) {
			...
			$( '.job_listing-map-wrapper, .job_listing-map' ).css( 'height', h );
		}
	}
