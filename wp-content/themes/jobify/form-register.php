...
<form action="<?php echo $action; ?>" method="post" id="register-form" class="job-manager-form" enctype="multipart/form-data">
	...
	<p class="register-submit" style="margin-bottom:0px; border-bottom: solid 1px #CCC">
	...
	<?php if( function_exists( 'paf' ) && $ptjf_text = paf( 'ptjf-text' ) ) { ?>
		<div style="margin-top: 30px;">
			<?php echo apply_filters( 'the_content', $ptjf_text );?>
		</div>
	<?php } ?>
</form>