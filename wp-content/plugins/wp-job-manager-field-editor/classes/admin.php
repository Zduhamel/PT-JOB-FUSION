...
class WP_Job_Manager_Field_Editor_Admin extends WP_Job_Manager_Field_Editor_Fields {
	...
	function assets(){
		...
		if( ! class_exists( 'WP_Job_Manager_Field_Editor_Assets' ) ) include( WPJM_FIELD_EDITOR_PLUGIN_DIR . '/classes/admin/assets.php' );
		$this->assets = new WP_Job_Manager_Field_Editor_Assets();
		return $this->assets;
