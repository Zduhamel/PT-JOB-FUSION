...
class WP_Job_Manager_Field_Editor_Assets {
	...
	function register_assets() {
		...
		wp_register_script( 'jmfe-radio-field', WPJM_FIELD_EDITOR_PLUGIN_URL . $radio, array( 'jquery' ), $scripts_version, TRUE );
		wp_register_script( 'jmfe-vendor-phone-field', WPJM_FIELD_EDITOR_PLUGIN_URL . $vendor_phone, array( 'jquery' ), $scripts_version, TRUE );
		wp_register_script( 'jmfe-phone-field', WPJM_FIELD_EDITOR_PLUGIN_URL . $phone, array( 'jquery', 'jmfe-vendor-phone-field' ), $scripts_version, TRUE );
		wp_register_script( 'jmfe-date-field', WPJM_FIELD_EDITOR_PLUGIN_URL . $date, array( 'jquery', 'jquery-ui-datepicker' ), $scripts_version, TRUE );
