 ...
 * Last Updated: Wed Apr 08 2015 23:40:33
 */
...
Class WP_Job_Manager_Field_Editor extends sMyles_Update {
	...
	/**
	 *  Register Frontend Scripts and/or Styles
	 *
	 *  Register any needed frontend scripts or styles to be enqueued from other
	 *  files such as templates, etc.
	 *
	 * @since 1.1.13
	 *
	 */
	function frontend_scripts(){
		...
		wp_register_script( 'jmfe-phone-field', WPJM_FIELD_EDITOR_PLUGIN_URL . '/assets/js/phone.min.js', array( 'jquery', 'jmfe-vendor-phone-field' ), WPJM_FIELD_EDITOR_VERSION, TRUE );
		wp_register_script( 'jmfe-date-field', WPJM_FIELD_EDITOR_PLUGIN_URL . '/assets/js/date.min.js', array( 'jquery', 'jquery-ui-datepicker' ), WPJM_FIELD_EDITOR_VERSION, TRUE );
